...
export const SurveyHeader: React.FC = () => {
  return (
    <div className="bg-white rounded-lg shadow-lg p-8 mb-8 text-center">
      ...
      <p className="text-lg text-gray-600 mb-4">Help us understand which services you value most</p>
      <div className="bg-blue-50 rounded-lg p-4 max-w-2xl mx-auto mb-8">
        <p className="text-sm text-blue-800">
          <strong>Instructions:</strong> Rate each service based on how valuable it would be to you as a client
        </p>
